...
var init = () => {
    ...
    // c1
    {
        ...
        c1 = theory.createUpgrade(0, currency, new FirstFreeCost(new ExponentialCost(1, 1)));
    ...
    // c2
    {
        ...
        c2 = theory.createUpgrade(1, currency, new ExponentialCost(1, Math.log2(2)));
        c2.getDescription = (_) => Utils.getMath(getDesc(c2.level));
        c2.getInfo = (amount) => Utils.getMathTo(getInfo(c2.level), getInfo(c2.level + amount));
    }
    // tau
    {
        let getDesc = (level) => "tau=tau^{" + level + "}";
        let getInfo = (level) => "c_2=" + level;
